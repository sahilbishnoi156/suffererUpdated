      ...
      <div className="py-8 h-3/4 px-4 mx-auto max-w-screen-xl text-center lg:py-16 flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          <div>
            ...
            <h5 className="text-2xl text-green-500 ">
              Where Words Find Wings!
            </h5>
          </div>
          <p className="text-sm font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">
            Unleash the Power of Words and Inspiration. Share, Connect, and
            Discover a World of Wisdom Are you ready to dive into a world of
            endless wisdom? Join Sufferer today and explore the boundless power
            of words!
          </p>
        </div>
